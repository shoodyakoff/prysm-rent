...
1. Создать страницу `/pages/rent-roll.html` (используя `components/header.html` и `components/sidebar.html`)
2. Подключить стили `css/style.css` и скрипт `js/main.js`
3. Реализовать блок из 6 ключевых метрик портфеля
4. Добавить систему табов по типам недвижимости (реализация на Vanilla JS)
5. Внутри каждого таба реализовать:
...
6. Реализовать переключатель НДС
7. Добавить функционал поиска и фильтрации в таблице (Vanilla JS)
8. Реализовать кнопку "Назад" для возврата на главную
